import { restoreSpans } from "./annotationTool/text.js";
import { getStore, setStore } from "./annotationTool/store.js";
import { createAnnotationTool } from "./annotationTool/annotationTool.js";

const annotationTool = createAnnotationTool();
...
const createText = () => {
  ...
  const spanified = annotationTool.spanifyAndAnnotate(text);
  spanified.forEach((span) => {
    textDiv.appendChild(span);
  });
  annotationTool.removeMenuOnScroll(textDiv);
  return { text, textDiv };
};
