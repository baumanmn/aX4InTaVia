...
ElemAddress.prototype.getElement = function () {
  ...
  switch (this.type) {
    case "HeadToken": {
      ...
      element = d3.selectAll(".bgToken_g" + className);
      break;
    }
    case "HeadTerm": {
    ...
    case "HeadTermIndicator": {
      ...
      element = d3.selectAll(".textIndicator_g" + indicatorID);
      break;
    }
    case "ChartToken": {
      var tokenId = ".idu" + this.user + "_t" + this.id;
      element = d3.selectAll(".bgTokenUsr" + tokenId);
      break;
    }
    case "ChartBin": {
      var binClassName = ".idu" + this.user + "_b" + this.id;
      element = d3.selectAll(".bgBinUsr.aggregated" + binClassName);
      break;
    }
    case "ChartAnno": {
    ...
    case "SAChartBackground": {
      var className = ".idt" + this.id;
      element = d3.selectAll(".bgToken" + className);
      break;
    }
    case "AChartBackground": {
      var className = ".idb" + this.id;
      element = d3.selectAll(".bgBin" + className);
      break;
    }
    case "TextToken": {
