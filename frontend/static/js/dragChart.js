...
const dragWindowWidth = 50; //tokenExt of the drag window
...
export function dragChart(chart) {
  ...
  var tokenBarHeight = chart.p.annotatorBandsExt; //height of the annotators part of the detail window
  var userHeight = chart.p.userHeight; //height of a user layer
  //var wordViewExt = chart.p.wordViewExt;  //height of the token text window
  //var dragWindowWidth = chart.p.overviewExt;  //height of the overview window
